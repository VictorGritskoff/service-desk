...
(
    ...
    setting_value varchar(1000) COLLATE pg_catalog."default" NOT NULL,
    setting_type varchar(50) COLLATE pg_catalog."default" NOT NULL,
    setting_group varchar(50) COLLATE pg_catalog."default",
...
(
    ...
    descriptive_name varchar(50) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    status varchar(50) COLLATE pg_catalog."default" NOT NULL DEFAULT 'ACTIVE'::varchar,
    ...
    short_name varchar(10) COLLATE pg_catalog."default" NOT NULL,
    tenant_id uuid NOT NULL,
...
(
    ...
    estimation_unit varchar(50) COLLATE pg_catalog."default",
...
(
    ...
    access_type varchar(20) COLLATE pg_catalog."default" NOT NULL DEFAULT 'SUBDOMAIN'::varchar,
...
(
    ...
    request_title varchar(255) COLLATE pg_catalog."default",
    ...
    iteration_id bigint,
    epic_id bigint,
    size varchar(15) COLLATE pg_catalog."default",
    estimate integer,
    created_by bigint,
    created_at timestamp with time zone,
    modified_by bigint,
...
(
    ...
    timezone varchar(100) COLLATE pg_catalog."default" DEFAULT 'America/Los_Angeles'::varchar,
    ...
    status varchar(20) COLLATE pg_catalog."default" NOT NULL DEFAULT 'PENDING'::varchar,
    is_deleted boolean NOT NULL DEFAULT false,
...
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    user_id bigint NOT NULL,
    auth_provider varchar(50) COLLATE pg_catalog."default" NOT NULL,
    provider_user_id varchar(256) COLLATE pg_catalog."default",
    password_hash varchar(61) COLLATE pg_catalog."default",
    tenant_id uuid NOT NULL,
...
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    name varchar(255) COLLATE pg_catalog."default" NOT NULL,
    request_name varchar(255) COLLATE pg_catalog."default" NOT NULL,
    description text COLLATE pg_catalog."default",
    owner_id bigint,
    visibility varchar(50) COLLATE pg_catalog."default" NOT NULL DEFAULT 'PRIVATE'::varchar,
...
(
    ...
    action_type varchar(255) COLLATE pg_catalog."default" NOT NULL,
    action_data json,
    tenant_id uuid NOT NULL,
