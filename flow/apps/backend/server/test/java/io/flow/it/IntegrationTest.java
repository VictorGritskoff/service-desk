...
import io.flow.FlowApp;
import io.flow.config.FlowProperties;
import io.flow.config.JacksonConfiguration;
 ...
 *
 * <ul>
 *   <li>{@link SpringBootTest} configured with the main application class {@link FlowApp}
 *       and {@link JacksonConfiguration} for proper JSON serialization/deserialization
 *   <li>{@link EnableConfigurationProperties} to load {@link FlowProperties} for test
 *       configuration
...
@SpringBootTest(classes = {FlowApp.class, JacksonConfiguration.class})
