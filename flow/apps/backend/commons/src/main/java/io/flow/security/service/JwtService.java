package io.flow.security.service;

import static io.flow.security.SecurityUtils.AUTHORITIES_KEY;
import static io.flow.security.SecurityUtils.JWT_ALGORITHM;
import static io.flow.security.SecurityUtils.TENANT_ID;
import static io.flow.security.SecurityUtils.USER_ID;

import io.flow.security.domain.FwUserDetails;
